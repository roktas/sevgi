  ...
  module Geometry
    class GridTest < Minitest::Test
      ...
      def test_grid_x_major
        ...
        grid.x.major.lines.each { assert(it.is_a?(Line)) }
      ...
      def test_grid_x_halve
        ...
        grid.x.halve.lines.each { assert(it.is_a?(Line)) }
      ...
      def test_grid_x_minor
        ...
        grid.x.minor.lines.each { assert(it.is_a?(Line)) }
      ...
      def test_grid_y_major
        ...
        grid.y.major.lines.each { assert(it.is_a?(Line)) }
      ...
      def test_grid_y_halve
        ...
        grid.y.halve.lines.each { assert(it.is_a?(Line)) }
      ...
      def test_grid_y_minor
        ...
        grid.y.minor.lines.each { assert(it.is_a?(Line)) }
      ...
      def test_grid_tiled
        ...
        [
          ...
          3,                              gt.rows.size,
          2,                              gt.cols.size,
          8.0,                            F.approx(gt.box.width),
          6.0,                            F.approx(gt.box.height),
          Rect[4, 2],                     gt.cell,
          Rect[4, 2, position: [ 4, 2 ]], gt[1][1],
          [
            [ Rect[4, 2, position:   Origin], Rect[4, 2, position: [ 4, 0 ]] ],
            [ Rect[4, 2, position: [ 0, 2 ]], Rect[4, 2, position: [ 4, 2 ]] ],
            [ Rect[4, 2, position: [ 0, 4 ]], Rect[4, 2, position: [ 4, 4 ]] ],
          ],                              gt.rows,
          [
            [ Rect[4, 2, position:   Origin], Rect[4, 2, position: [ 0, 2 ]], Rect[4, 2, position: [ 0, 4 ]] ],
            [ Rect[4, 2, position: [ 4, 0 ]], Rect[4, 2, position: [ 4, 2 ]], Rect[4, 2, position: [ 4, 4 ]] ],
          ],                              gt.cols,
          [
            Rect[4, 2, position:     Origin], Rect[4, 2, position: [ 4, 0 ]]
          ],                              gt.row,
      ...
      def test_grid_boxes
        ...
        [
          Rect[4, 6, position: [ 4, 0 ]], gt.colbox(1),
          Rect[4, 6, position:   Origin], gt.colbox,
          Rect[8, 2, position: [ 0, 2 ]], gt.rowbox(1),
          Rect[8, 2, position:   Origin], gt.rowbox,
        ].each_slice(2) { |expected, actual| assert_equal(expected, actual) }
      end
    end
  end
