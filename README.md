...
> [!NOTE] Project code before version 0.42.0 was written manually, without AI assistance. Starting with version 0.42.0,
> AI assistance is used actively, especially for tests and documentation.
